...
function htmlStuff() {
  ...
  depthPara.parent("canvas-holder")
  depthPara.id('difficulty-info')

  depthMinus = createButton("-");
  depthMinus.parent("difficulty-info")
  depthMinus.id('minus-button')
  
  depthPlus = createButton('+');
  depthPlus.parent("difficulty-info")
  depthPlus.id('plus-button')
